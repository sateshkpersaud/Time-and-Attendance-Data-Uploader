...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="updPnl" runat="server">
        <ContentTemplate>
            ...
            <h2 class="content-wrapper">Time Detail</h2>
            ...
            <div id="divTime" style="width: 80%; overflow: auto; margin-left: auto; margin-right: auto;">
                <asp:GridView ID="gvTime" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="50"
                    DataKeyNames="RecordId,Shiftid" CellPadding="4" ForeColor="#333333" HorizontalAlign="Center" ShowHeader="false"
                    ShowFooter="True" GridLines="Both" OnRowCreated="gvTime_RowCreated" OnRowDataBound="gvTime_RowDataBound"
                     OnPageIndexChanging="gvTime_PageIndexChanging" Width="100%">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="WorkDate" HeaderText="Work Date" SortExpression="WorkDate" DataFormatString="{0:d}" ItemStyle-HorizontalAlign="Center"/>
                        ...
                        <asp:BoundField DataField="OverNight" HeaderText="Over Night" SortExpression="OverNight" ItemStyle-HorizontalAlign="Center" />
                        ...
                        <asp:BoundField DataField="Rate" HeaderText="Rate" SortExpression="Rate" NullDisplayText="-" ItemStyle-HorizontalAlign="Center" />
                        ...
                        <asp:BoundField DataField="EstateLocationID" HeaderText="Estate Location" SortExpression="EstateLocationID" ItemStyle-HorizontalAlign="Center" />
                        ...
                        <asp:BoundField DataField="TypeOfEntry" HeaderText="Type Of Entry" SortExpression="TypeOfEntry" NullDisplayText="-" ItemStyle-HorizontalAlign="Center"/>
