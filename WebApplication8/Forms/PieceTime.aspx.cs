...
{
    public partial class PieceTime : System.Web.UI.Page
    {
        ...
        protected void btnSTUpload_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow rows in gvTime.Rows)
            {
                ...
                if (cbSelect.Checked)
                {
                    ...
                    //string overnight = rows.Cells[11].Text == "-" ? "" : rows.Cells[11].Text.TrimEnd(' ');
                    //string hasSplit = rows.Cells[12].Text == "-" ? "" : rows.Cells[12].Text.TrimEnd(' ');
                    //string activityMaster = rows.Cells[18].Text == "-" ? "" : rows.Cells[16].Text.TrimEnd(' ');
                    //string holdingAccCode = rows.Cells[20].Text == "-" ? "" : rows.Cells[18].Text.TrimEnd(' ');
                    //string locationID = rows.Cells[21].Text == "-" ? "" : rows.Cells[19].Text.TrimEnd(' ');
                    //string chargedTo = rows.Cells[22].Text == "-" ? "" : rows.Cells[20].Text.TrimEnd(' ');
                    ...
                    string insertQuery = "INSERT INTO TBL_5_EXPORT_PIECETIME (" +
                                         "RECORDID," +
                                         "FIRSTNAME," +
                                         "LASTNAME," +
                                         "EMP_SEQ_NO," +
                    ...
                    {
                        DataTier.setUploadStatus_PieceTime(recordId, BusinessTier.loggedInUser());
                        if (!DataTier.successfulCommit)
                        {
                            failedCommits++;
                            failedRecords += rows.Cells[5].Text + ",";
                            DataTier.deleteRecord(ConnectionString, "TBL_5_EXPORT_PIECETIME", recordId);
                        }
                    }
                }
            }
        ...
        private void loadGridviewData()
        {
            ...
            var query1 = (from a in context.tbl_5_Export_PieceTime
        ...
        //protected void Demonstration_Click(object sender, EventArgs e)
        //{
        //    if (btnShowHide.Visible == false)
        //    {
        //        btnShowHide.Visible = true;
        //    }
        //    else if (btnShowHide.Visible == true)
        //    {
        //        btnShowHide.Visible = false;
        //    }
        //}
