...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PieceTime.aspx.cs" Inherits="WebApplication8.TimeDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="EntityDataSource1" DataKeyNames="RecordId" CellPadding="4" ForeColor="#333333" HorizontalAlign="Center" ShowFooter="True" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="TotalEarnings" HeaderText="TotalEarnings" SortExpression="TotalEarnings" Visible ="True"/>
            <asp:BoundField DataField="ActivityMaster" HeaderText="ActivityMaster" SortExpression="ActivityMaster"/>
            <asp:BoundField DataField="ActivityCode" HeaderText="ActivityCode" SortExpression="ActivityCode" />
            ...
            <asp:BoundField DataField="EstateLocationID" HeaderText="EstateLocationID" SortExpression="EstateLocationID" Visible ="True"/>
            <asp:BoundField DataField="EstateID" HeaderText="EstateID" SortExpression="EstateID" />
            <asp:BoundField DataField="TypeOfEntry" HeaderText="TypeOfEntry" SortExpression="TypeOfEntry" />
        ...
        <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=AcuPayEntities" DefaultContainerName="AcuPayEntities" EnableFlattening="False" EntitySetName="tbl_5_Export_PieceTime" AutoGenerateOrderByClause="True" OrderBy="">
            <OrderByParameters>
